...
export class UsuariosController {
  ...
  static async obtenerPermisosDisponibles(req: AuthRequest, res: Response) {
    try {
      console.log('🔍 obtenerPermisosDisponibles - Iniciando...');
      console.log('👤 Usuario autenticado:', req.user ? { userId: req.user.userId, rol: req.user.rol } : 'No user');
      ...
      console.log('✅ Permisos formateados:', permisosFormateados.length);
